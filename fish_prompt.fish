...
# Define colors
set -U mudfencer_night 000000 083743 445659 fdf6e3 ff74f3 cb4b16 dbff52 f1ffa5 6c71c4 3fffff 2aa198 859900
set -U mudfencer_day 000000 333333 666666 ffffff ff00e9 ff6600 c9ff00 e0ff3a 3300ff 00ffff 00ffff 00ff00
...
function __mudfencer_prompt_bindmode -d 'Displays the current mode'
  ...
  switch $pwd_style
    case short long
      echo -n " " (task rc.verbose=nothing rc.gc=off +in +PENDING count) " "
  end
